...
public class PlayerPhysical : MonoBehaviour
{
    ...
    [SerializeField] private float _wallCheckDistance = 0.1f; // 벽 감지 거리
    ...
    [SerializeField] private LayerMask _wallLayers = 1 << 13; // 벽
    ...
    public LayerMask WallLayers { get { return _wallLayers; } }
    ...
    public void SetJump()
    {
        _finalJump = 2f + player.PlayerStats.FinalStats.Jump * 0.5f;
    }
